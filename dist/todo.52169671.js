...
var todoForm = document.querySelector(".todo_form");
var todoInput = todoForm.querySelector("input");
var todoList = document.querySelector(".todo_List");
var TODOS_LS = "toDos"; //localStorage의 key:value

var toDos = []; //HTML 삭제

function deleteToDo(e) {
  var btn = e.target; //console.dir(btn); -> 부모요소인 li를 찾음

  var li = btn.parentNode;
  todoList.removeChild(li); //localStorage에서 삭제
...
var paintToDo = function paintToDo(text) {
